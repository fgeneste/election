...
import { CspComponent } from 'app/entities/csp/csp.component';
import { CspService } from 'app/entities/csp/csp.service';
import { Csp } from 'app/shared/model/csp.model';

describe('Component Tests', () => {
  describe('Csp Management Component', () => {
    let comp: CspComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.csps && comp.csps[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
