...
export class CandidatComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.candidatService
      ...
      .subscribe((res: HttpResponse<ICandidat[]>) => this.paginateCandidats(res.body, res.headers));
  }
  ...
  registerChangeInCandidats(): void {
    this.eventSubscriber = this.eventManager.subscribe('candidatListModification', () => this.reset());
  }
  ...
  protected paginateCandidats(data: ICandidat[] | null, headers: HttpHeaders): void {
