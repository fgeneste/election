...
/**
 * REST controller for managing {@link fr.senat.election.domain.Fichier}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FichierResource {
    ...
    public ResponseEntity<Fichier> updateFichier(@Valid @RequestBody Fichier fichier) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fichier.getId().toString()))
            .body(result);
    }
